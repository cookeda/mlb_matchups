    ...
    async def run(self):
        ...
        async with async_playwright() as p:
            ...
            for matchup in mod_divs:
                ...
                if preview_link:
                    preview_link = urljoin(page.url, preview_link)
                ...
                self.matchups.append({
                    ...
                    'away_pitcher_link': urljoin(page.url, away_pitcher_link) if away_pitcher_link else None,
                    'away_pitcher_number': away_pitcher_number,
                    'away_pitcher_throws': away_pitcher_throws,
                    'away_stats': away_stats,
                    'home_pitcher_name': home_pitcher_name,
                    'home_pitcher_link': urljoin(page.url, home_pitcher_link) if home_pitcher_link else None,
